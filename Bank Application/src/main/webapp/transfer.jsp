...
function check(){
	...
	if(v4==""){
		alert("Please enter the target account number");
		document.f.accno2.focus();
		return false;
	}
	if(v5==""){
...
<h1 style="color:green">TRANSFER FORM</h1><br><br>
Account Number:<input type="number" name="accno"><br><br>
Name:<input type="text" name="uname"><br><br>
Password:<input type="password" name="psw"><br><br>
Target Account Number:<input type="number" name="accno2"><br><br>
